                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('setoran.update', $setoran->id_setoran) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            @error('id_santri')
                                <span class="text-danger">Nama santri wajib dipilih.</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @error('id_kelas')
                                <span class="text-danger">Kelas wajib dipilih.</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @error('tgl_setoran')
                                <span class="text-danger">Tanggal setoran wajib diisi.</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="id_pengajar">Target</label>
                        ...
                        <div class="form-group">
                            ...
                            @error('id_surat')
                                <span class="text-danger">Surat wajib dipilih.</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @error('jumlah_ayat_start')
                                <span class="text-danger">Ayat mulai wajib diisi.</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @error('jumlah_ayat_end')
                                <span class="text-danger">Ayat akhir wajib diisi.</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="id_target" id="id_target" class="form-control">
                                    <option value="">Pilih Pengajar</option>
                                    @foreach($targets as $target)
                                        <option value="{{ $target->id_target }}" {{ old('id_target') == $target->id_target ? 'selected' : '' }}>
                                            {{ $target->keterangan }}
                                        </option>
                                    @endforeach
                                </select>
