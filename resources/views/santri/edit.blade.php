                            ...
                            <form action="{{ route('santri.update', $santri->id_santri) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control @error('status') is-invalid @enderror">
                                        <option value="1" {{ old('status', $santri->status) == 1 ? 'selected' : '' }}>
                                            Aktif</option>
                                        <option value="0" {{ old('status', $santri->status) == 0 ? 'selected' : '' }}>
                                            Nonaktif</option>
                                    </select>
                                    @error('status')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="foto_santri" id="foto_santri"
                                        class="form-control @error('foto_santri') is-invalid @enderror" accept="image/*"
                                ...
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <textarea name="alamat_wali" class="form-control @error('alamat_wali') is-invalid @enderror">{{ old('alamat_wali', $wali->alamat ?? '') }}</textarea>
                                    @error('alamat_wali')
                                        <span class="text-danger">Alamat tidak boleh kosong.</span>
                                    @enderror
                                </div>
