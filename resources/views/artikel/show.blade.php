                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover artikel-list w-100">
                                    ...
                                    <tbody>
                                        @foreach ($articles as $key => $article)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($article->gambar)
                                                        <img src="{{ $article->gambar }}" width="100" class="img-fluid" alt="Gambar Artikel">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{ route('artikel.edit', $article->id) }}" class="btn btn-warning btn-sm">
