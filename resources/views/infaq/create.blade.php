            ...
            <div class="card-body">
                ...
                <form action="{{ route('infaq.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_infaq" id="tgl_infaq" class="form-control @error('tgl_infaq') is-invalid @enderror" value="{{ old('tgl_infaq') ?? date('Y-m-d') }}" required>
                        @error('tgl_infaq')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="nominal_infaq" id="nominal_infaq" class="form-control @error('nominal_infaq') is-invalid @enderror" value="{{ old('nominal_infaq') }}" required>
                        @error('nominal_infaq')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
