...
<section class="content">
    ...
    style="max-height: 350px; width: 100%; height: auto; object-fit: cover;">
                                        ...
                                        <div class="mt-2">
                                            <button type="button" class="btn btn-primary" onclick="document.getElementById('foto_pengajar').click();">
                                                Choose Image
                                            </button>
                                        ...
                                        <input type="file" name="foto_pengajar" id="foto_pengajar"
                                            class="d-none @error('foto_pengajar') is-invalid @enderror"
                                            accept="image/*" onchange="previewImage(event)">

                                        @error('foto_pengajar')
                                            <span class="text-danger d-block">Format gambar tidak valid atau ukuran terlalu besar.</span>
                                        @enderror
                                    </div>
                                </div>
